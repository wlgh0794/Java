...
public class _01_CreateArray {
	...
	public static void main(String[] args) {
		...
		// 1 . 배열의 선언
		// 자료형[] 변수명( 배열명 ) = new 자료형 [ 배열의 길이 ( 저장될 값의 갯수 ) ] ;
		// 기본 자료형 또는 참조타입의 자료형으로 배열을 생성할 수 있다.
		...
		// 마지막 인덱스는 배열의 길이 -1 .
		// { 1 , 2, , ,  5  }
		// 값을 input  하지 않으면 0으로 자동으로 초기화 된다.
		...
		// 배열 값의 사용
		// 각각의 인덱스로 접근해서 사용한다.
		// 변수명[ 인덱스 ] 인덱스 번째에 저장되어 있는 값을 꺼내서 사용
...
//		System.out.println( intArr[4] ); // [ 오류 ]
		...
		System.out.println( strArr[ 2 ] ) ; // 값이 없으면 Null
